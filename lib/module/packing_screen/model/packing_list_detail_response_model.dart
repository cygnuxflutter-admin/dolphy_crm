...
PackingListDetailResponse packingListDetailResponseFromJson(String str) => PackingListDetailResponse.fromJson(json.decode(str));

String packingListDetailResponseToJson(PackingListDetailResponse data) => json.encode(data.toJson());
...
class PackingListDetailResponse {
  ...
  PackingListDetailResponse({this.success, this.message, this.data, this.status, this.error});

  factory PackingListDetailResponse.fromJson(Map<String, dynamic> json) => PackingListDetailResponse(
    success: json["success"] as bool?,
    message: json["message"] as String?,
    data: json["data"] == null ? null : PackingListDetailData.fromJson(json["data"] as Map<String, dynamic>),
...
class PackingListDetailData {
  ...
  final PackingListSummary? summary;
  ...
  factory PackingListDetailData.fromJson(Map<String, dynamic> json) => PackingListDetailData(
    id: json["id"] as String?,
    tenantId: json["tenant_id"] as String?,
    packingNo: json["packing_no"] as String?,
    packingDate: json["packing_date"] == null ? null : DateTime.tryParse(json["packing_date"] as String),
    ...
    packedAt: json["packed_at"] == null ? null : DateTime.tryParse(json["packed_at"] as String),
    ...
    customer: json["customer"] == null ? null : PackingListCustomer.fromJson(json["customer"] as Map<String, dynamic>),
    picking: json["picking"] == null ? null : PackingListPicking.fromJson(json["picking"] as Map<String, dynamic>),
    invoice: json["invoice"] == null ? null : PackingListInvoice.fromJson(json["invoice"] as Map<String, dynamic>),
    shippingAddress: json["shipping_address"],
    billingAddress: json["billing_address"],
    customerAddresses: json["customer_addresses"] == null
        ? null
        : List<PackingListCustomerAddress>.from(
            (json["customer_addresses"] as List).map((x) => PackingListCustomerAddress.fromJson(x as Map<String, dynamic>)),
          ),
    items: json["items"] == null
        ? null
        : List<PackingListDataItem>.from((json["items"] as List).map((x) => PackingListDataItem.fromJson(x as Map<String, dynamic>))),
    ...
    logs: json["logs"] == null
        ? null
        : List<PackingListLog>.from((json["logs"] as List).map((x) => PackingListLog.fromJson(x as Map<String, dynamic>))),
    summary: json["summary"] == null ? null : PackingListSummary.fromJson(json["summary"] as Map<String, dynamic>),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "customer_addresses": customerAddresses?.map((x) => x.toJson()).toList(),
...
class PackingListSummary {
  ...
  PackingListSummary({this.totalProducts, this.totalPackedQty, this.totalSuggestedBoxes, this.totalActualBoxes});

  factory PackingListSummary.fromJson(Map<String, dynamic> json) => PackingListSummary(
...
class PackingListCustomer {
  ...
  factory PackingListCustomer.fromJson(Map<String, dynamic> json) => PackingListCustomer(
    ...
    allowTransactionBeyondCredit: json["allow_transaction_beyond_credit"] as bool?,
...
class PackingListCustomerAddress {
  ...
  factory PackingListCustomerAddress.fromJson(Map<String, dynamic> json) => PackingListCustomerAddress(
    id: json["id"] as String?,
...
class PackingListInvoice {
  ...
  factory PackingListInvoice.fromJson(Map<String, dynamic> json) => PackingListInvoice(
    ...
    invoiceDate: json["invoice_date"] == null ? null : DateTime.tryParse(json["invoice_date"] as String),
    dueDate: json["due_date"] == null ? null : DateTime.tryParse(json["due_date"].toString()),
    subtotal: json["subtotal"] as String?,
    totalBeforeDiscountAmount: json["total_before_discount_amount"] as String?,
    ...
    piApprovedAt: json["pi_approved_at"] == null ? null : DateTime.tryParse(json["pi_approved_at"].toString()),
    isPostedForPi: json["is_posted_for_pi"] as bool?,
    postedForPiBy: json["posted_for_pi_by"] as String?,
    postedForPiAt: json["posted_for_pi_at"] == null ? null : DateTime.tryParse(json["posted_for_pi_at"].toString()),
    ...
    charges: json["charges"] == null ? null : List<dynamic>.from(json["charges"] as List),
    paymentTermsName: json["payment_terms_name"] as String?,
    items: json["items"] == null
        ? null
        : List<PackingListInvoiceItem>.from((json["items"] as List).map((x) => PackingListInvoiceItem.fromJson(x as Map<String, dynamic>))),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "ewayCancelledAt": ewayCancelledAt,
    "ewayCancelledBy": ewayCancelledBy,
    "ewayCancelRemarks": ewayCancelRemarks,
    "is_irn_cancelled": isIrnCancelled,
    "irnCancelledAt": irnCancelledAt,
    "irnCancelledBy": irnCancelledBy,
    "irnCancelRemarks": irnCancelRemarks,
    "cancelledTiRef": cancelledTiRef,
    "piTypeId": piTypeId,
    "piType": piType,
    "charges": charges,
...
class PackingListPicking {
  ...
  factory PackingListPicking.fromJson(Map<String, dynamic> json) => PackingListPicking(
    ...
    pickingDate: json["picking_date"] == null ? null : DateTime.tryParse(json["picking_date"] as String),
    invoiceId: json["invoice_id"] as String?,
    pickRequestId: json["pick_request_id"] as String?,
    customerId: json["customer_id"] as String?,
    warehouseId: json["warehouse_id"],
...
class PackingListDataItem {
  ...
  factory PackingListDataItem.fromJson(Map<String, dynamic> json) => PackingListDataItem(
    ...
    productId: json["product_id"] as String?,
    pickedQty: json["picked_qty"]?.toString(),
    packedQty: json["packed_qty"]?.toString(),
    ...
    serialIds: json["serial_ids"] == null ? null : List<String>.from(json["serial_ids"] as List),
    weight: json["weight"],
    remarks: json["remarks"],
    createdBy: json["created_by"] as String?,
    updatedBy: json["updated_by"],
    ...
    updatedAt: json["updated_at"] == null ? null : DateTime.tryParse(json["updated_at"].toString()),
    isDeleted: json["is_deleted"] as bool?,
    product: json["product"] == null ? null : PackingListProduct.fromJson(json["product"] as Map<String, dynamic>),
    isBatchWise: json["is_batch_wise"] as bool?,
    serialNumbers: json["serial_numbers"] == null ? null : List<String>.from(json["serial_numbers"].where((x) => x != null).map((x) => x.toString())),
    batchQuantity: json["batch_quantity"] as int?,
    batchNumbers: json["batch_numbers"] == null ? null : List<String>.from(json["batch_numbers"] as List),
  );
...
class PackingListProduct {
  ...
  factory PackingListProduct.fromJson(Map<String, dynamic> json) => PackingListProduct(
    ...
    companyIds: json["company_ids"] == null ? null : List<dynamic>.from(json["company_ids"] as List),
    createdBy: json["created_by"] as String?,
    updatedBy: json["updated_by"] as String?,
    createdAt: json["created_at"] == null ? null : DateTime.tryParse(json["created_at"].toString()),
    updatedAt: json["updated_at"] == null ? null : DateTime.tryParse(json["updated_at"].toString()),
