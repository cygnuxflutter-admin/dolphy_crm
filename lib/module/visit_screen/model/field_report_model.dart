...
class FieldReportModel {
  ...
  FieldReportModel({this.success, this.message, this.data, this.status, this.error});
...
class Technician {
  ...
  Technician({this.id, this.name, this.isPrimary});
...
class TrackingLog {
  ...
  TrackingLog({this.id, this.visitId, this.userId, this.action, this.latitude, this.longitude, this.remark, this.createdAt});
