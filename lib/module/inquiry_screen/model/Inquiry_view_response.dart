...
//
//     final leadViewResponse = leadViewResponseFromJson(jsonString);

import 'dart:convert';

InquiryViewResponse leadViewResponseFromJson(String str) => InquiryViewResponse.fromJson(json.decode(str));

String leadViewResponseToJson(InquiryViewResponse data) => json.encode(data.toJson());

class InquiryViewResponse {
  final bool? success;
  final String? message;
  final InquiryViewData? data;
  final int? status;
  final dynamic error;

  InquiryViewResponse({this.success, this.message, this.data, this.status, this.error});

  factory InquiryViewResponse.fromJson(Map<String, dynamic> json) => InquiryViewResponse(
    success: json["success"],
    message: json["message"],
    data: json["data"] == null ? null : InquiryViewData.fromJson(json["data"]),
    status: json["status"],
    error: json["error"],
  );
...
class InquiryViewData {
  ...
  final List<dynamic>? tagNamesList;
  final dynamic gstCategoryName;
  final List<LeadViewAddress>? addresses;
  ...
  InquiryViewData({
    ...
    this.tagNamesList,
    this.gstCategoryName,
    this.addresses,
    this.summary,
  });

  factory InquiryViewData.fromJson(Map<String, dynamic> json) => InquiryViewData(
    id: json["id"],
    ...
    tagNamesList: json["tag_names_list"] == null ? [] : List<dynamic>.from(json["tag_names_list"]!.map((x) => x)),
    gstCategoryName: json["gst_category_name"],
    addresses: json["addresses"] == null ? [] : List<LeadViewAddress>.from(json["addresses"]!.map((x) => LeadViewAddress.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "tag_names_list": tagNamesList == null ? [] : List<dynamic>.from(tagNamesList!.map((x) => x)),
    "gst_category_name": gstCategoryName,
    "addresses": addresses == null ? [] : List<dynamic>.from(addresses!.map((x) => x.toJson())),
    "summary": summary?.toJson(),
  };
}

class LeadViewAddress {
  final String? id;
  final String? type;
  final String? contactName;
  ...
  factory LeadViewAddress.fromJson(Map<String, dynamic> json) => LeadViewAddress(
    id: json["id"],
    type: json["type"],
    contactName: json["contact_name"],
    companyName: json["company_name"],
...
class Summary {
  ...
  Summary({this.totalOpportunities, this.totalQuotations, this.totalInvoices});

  factory Summary.fromJson(Map<String, dynamic> json) =>
      Summary(totalOpportunities: json["total_opportunities"], totalQuotations: json["total_quotations"], totalInvoices: json["total_invoices"]);

  Map<String, dynamic> toJson() => {"total_opportunities": totalOpportunities, "total_quotations": totalQuotations, "total_invoices": totalInvoices};
}
